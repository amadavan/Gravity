...
//            cout << endl;
        ...
        DebugOn(v->_name + ": " + std::to_string(problem_num));
    ...
    DebugOn("Master specified: " + std::to_string(master_specified));
    DebugOn("Subproblems specified: " + std::to_string(subproblems_specified));
}
